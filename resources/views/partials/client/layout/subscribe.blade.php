<div class="subscribe-modal" id="subscribe">
    ...
    <form action="{{route('client.subscribe')}}" method="post">
        ...
        <div class="mb-5">
            <label for="subscribe_first_name" class="block font-bold uppercase text-xs mb-2">@lang('forms.first_name')</label>
            <input type="text" class="form-control @error('subscribe_first_name') border-red @enderror" id="subscribe_first_name" name="subscribe_first_name"
        ...
        <div class="mb-5">
            <label for="subscribe_last_name" class="block font-bold uppercase text-xs mb-2">@lang('forms.last_name')</label>
            <input type="text" class="form-control @error('subscribe_last_name') border-red @enderror" id="subscribe_last_name" name="subscribe_last_name"
        ...
        <div class="mb-5">
            ...
            <input type="tel" class="form-control @error('subscribe_phone') border-red @enderror" id="phone" name="subscribe_phone"
        ...
        <div class="mb-5">
            ...
            <input type="email" class="form-control @error('subscribe_email') border-red @enderror" id="subscribe_email" name="email"
...
<div class="subscribe-modal-mask"></div>
